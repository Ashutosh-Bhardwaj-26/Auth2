...
import com.ashutosh.auth2.ui.auth.google_auth.GoogleSignInViewModel
...
class SignUpFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val phoneAuthButton = binding.countryCodePicker

        phoneAuthButton.setOnClickListener{
            findNavController().navigate(R.id.action_signUpFragment_to_phoneAuthFragment)
        }
